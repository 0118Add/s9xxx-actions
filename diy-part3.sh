...
#添加额外软件包
rm -rf feeds/luci/applications/{luci-app-daed,luci-app-passwall,luci-app-openclash}
rm -rf feeds/packages/net/{daed,xray-core,sing-box,v2ray-geodata}
...
#cat ${GITHUB_WORKSPACE}/patch/default-settings >> package/emortal/default-settings/files/99-default-settings
...
curl -fsSL https://raw.githubusercontent.com/0118Add/s9xxx-actions/main/patch/os-release > package/base-files/files/usr/lib/os-release
